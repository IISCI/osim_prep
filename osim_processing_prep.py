	...
	while True:
		try:
		    ...
		    if i >= 25:
		    	...
		    	VALUES.append("{0:.3f}".format(- float(row[6+FORCE_EXTRA_COLUMNS_TO_BE_REMOVED])/100)) # X_opensim = -X_QTM
		    	VALUES.append("{0:.3f}".format(float(row[8+FORCE_EXTRA_COLUMNS_TO_BE_REMOVED])/100)) # Y_opensim = Z_QTM
		    	VALUES.append("{0:.3f}".format(float(row[7+FORCE_EXTRA_COLUMNS_TO_BE_REMOVED])/100)) # Z_opensim = Y_QTM
		    	#now the other file
		    	for x in range(1,3):
		    	...
		    	VALUES.append("{0:.3f}".format(- float(row_right[6+FORCE_EXTRA_COLUMNS_TO_BE_REMOVED])/100)) # X_opensim = -X_QTM
		    	VALUES.append("{0:.3f}".format(float(row_right[8+FORCE_EXTRA_COLUMNS_TO_BE_REMOVED])/100)) # Y_opensim = Z_QTM
		    	VALUES.append("{0:.3f}".format(float(row_right[7+FORCE_EXTRA_COLUMNS_TO_BE_REMOVED])/100)) # Z_opensim = Y_QTM
